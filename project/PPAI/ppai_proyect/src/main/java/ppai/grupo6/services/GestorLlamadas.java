...
import ppai.grupo6.services.utils.ReactAppLauncher;
...
public class GestorLlamadas {
    ...
    private List<SeleccionRtasValidacionesDto> selecionesRtaCliente = new ArrayList<>();
    ...
    public void inicio(){
        this.llamada = this.llamadaService.findById(7);
    ...
    public void buscarFechaHoraActual() {
        this.fechaHoraActual = String.valueOf(LocalDateTime.now().withNano(0));
    }
    ...
    public void buscarAccionSeleccionada(){
        this.acciones.forEach(
                accion -> {
                    ...
                    System.out.println(accionRequerida);
    ...
    public void registrarFinalizacionDeLlamada(){
        this.fechaHoraAnterior = this.fechaHoraActual;
        this.buscarFechaHoraActual();
        System.out.println(fechaHoraActual);
        System.out.println(fechaHoraAnterior);
        this.llamada.finalizar(this.fechaHoraActual, this.fechaHoraAnterior , descripcionRespuesta, subOpcionLlamada);
        this.llamadaService.save(this.llamada);
        this.finCu();
    }
    ...
    public void registrarCancelacionDeLlamada(){
        this.fechaHoraAnterior = this.fechaHoraActual;
        this.buscarFechaHoraActual();
        this.llamada.cancelar(this.fechaHoraActual, this.fechaHoraAnterior);
        this.llamadaService.save(this.llamada);
        this.finCu();
    }
